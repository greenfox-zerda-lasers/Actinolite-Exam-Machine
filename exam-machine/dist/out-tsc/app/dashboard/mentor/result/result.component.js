...
var ResultComponent = (function () {
    function ResultComponent(dataService, alert, calculate, exams) {
    ...
    ResultComponent.prototype.renderResults = function () {
        ...
        this.dataService.getResultsById(this.current_id)
            ...
            .then(function () { return (_this.calculate.addPercents(_this.results)); })
...
ResultComponent = __decorate([
    ...
    __metadata("design:paramtypes", [DataService, AlertService, CalculateService, ExamsComponent])
], ResultComponent);
