...
export class DataService {
  ...
  getUserName(id) {
    return this.http.post('https://exam-machine-backend.gomix.me/self', {user_id: id}, {headers: this.headers})
      .map((res) => res.json())
  }

  fetchUsers() {
    return this.http.get('https://exam-machine-backend.gomix.me/users')
      .map((res) => res.json())
  }
  ...
  editCohort(name) {
    return this.http.put('https://exam-machine-backend.gomix.me/dashboard/cohorts', {cohort_name: name}, {headers: this.headers})
      .map((res) => res.json())
  }
